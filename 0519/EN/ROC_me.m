...
%% svm模型生成
%mdlSVM = fitcsvm(F,lab,'Standardize',true);
mdl = fitensemble(F,lab,'GentleBoost',50,'Tree')
%% 载入测试数据
...
load('E:\WZZ\OneDrive\0407\0519\EN\gt_labels.mat');
...
save('E:\WZZ\OneDrive\0407\0519\EN\LABELEN.mat','LABELEN');   
lll=[];
for i=1:10
    ll=LABELEN{i};
    lll=[lll;ll];%%label
...
enresult=[se,sp,acc,AUCsvm];
save('E:\WZZ\OneDrive\0407\0519\EN\enresult.mat','enresult');