...
%% knn
load('E:\WZZ\OneDrive\0407\0519\NB\scores_maps.mat');
load('E:\WZZ\OneDrive\0407\0519\NB\gt_labels.mat');
...
save('E:\WZZ\OneDrive\0407\0519\NB\LABELEN.mat','LABELEN');   
lll=[];
for i=1:10
    ll=LABELEN{i};
    lll=[lll;ll];%%label
...
save('E:\WZZ\OneDrive\0407\0519\NB\result.mat','result');